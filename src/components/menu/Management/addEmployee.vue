...
<div class="personalPageWhole">
 ...
 <el-button type="primary" :loading="loading"  @click="add('addInfo')">下一步</el-button>
    ...
    <el-card style="float: left; width:90%; margin-left: 5%;margin-top: 10px">
      ...
      <span slot="label" style="color: #403b3b">新增工作人员信息</span>
      </div>
      <el-form :inline=true ref="addInfo" :model="addInfo"  :rules="rules" label-width="220px" class="form">
                 <el-form-item prop="employeename"  >
                    <span slot="label"  style="color: #403b3b">工作人员姓名:       </span>
                    <el-input v-model="addInfo.employeename" style="width: 200px;"></el-input>
                </el-form-item>
                <el-form-item prop="sex"  >
                    <span slot="label"  style="color: #403b3b">工作人员性别:       </span>
                    <el-input v-model="addInfo.sex" style="width: 200px;"></el-input>
                </el-form-item>
                <el-form-item prop="phone"  >
                    <span slot="label"  style="color: #403b3b">工作人员电话号码:       </span>
                    <el-input v-model="addInfo.phone" style="width: 200px;"></el-input>
                </el-form-item>
                <el-form-item prop="idcard"  >
                    <span slot="label"  style="color: #403b3b">工作人员身份证:       </span>
                    <el-input v-model="addInfo.idcard" style="width: 200px;"></el-input>
                </el-form-item>
                <el-form-item prop="birthday"  >
                    <span slot="label"  style="color: #403b3b">工作人员出生日期:       </span>
                    <el-input v-model="addInfo.birthday" style="width: 200px;"></el-input>
                </el-form-item>
                <el-form-item prop="description"  >
                    <span slot="label"  style="color: #403b3b">工作人员描述:       </span>
